    ...
    (t.position = {
      ...
      (t.fn.position = function (e) {
        ...
        return (
          ...
          "right" === e.at[0]
            ? (g.left += d)
            : "center" === e.at[0] && (g.left += d / 2),
          "bottom" === e.at[1]
            ? (g.top += p)
            : "center" === e.at[1] && (g.top += p / 2),
          (h = c(x.at, d, p)),
          (g.left += h[0]),
          (g.top += h[1]),
          this.each(function () {
            ...
            "right" === e.my[0]
              ? (D.left -= r)
              : "center" === e.my[0] && (D.left -= r / 2),
              "bottom" === e.my[1]
                ? (D.top -= l)
                : "center" === e.my[1] && (D.top -= l / 2),
              (D.left += I[0]),
              (D.top += I[1]),
              (n = { marginLeft: m, marginTop: _ }),
              t.each(["left", "top"], function (i, s) {
                t.ui.position[k[i]] &&
                  t.ui.position[k[i]][s](D, {
                    targetWidth: d,
                    targetHeight: p,
                    elemWidth: r,
                    elemHeight: l,
      ...
      (t.ui.position = {
        fit: {
          left: function (t, e) {
            ...
            e.collisionWidth > a
              ? h > 0 && l <= 0
                ? ((s = t.left + h + e.collisionWidth - a - o),
                  (t.left += h - s))
                : (t.left =
                    l > 0 && h <= 0 ? o : h > l ? o + a - e.collisionWidth : o)
              : h > 0
              ? (t.left += h)
              : l > 0
              ? (t.left -= l)
          ...
          top: function (t, e) {
            ...
            e.collisionHeight > a
              ? h > 0 && l <= 0
                ? ((s = t.top + h + e.collisionHeight - a - o),
                  (t.top += h - s))
                : (t.top =
                    l > 0 && h <= 0 ? o : h > l ? o + a - e.collisionHeight : o)
              : h > 0
              ? (t.top += h)
              : l > 0
              ? (t.top -= l)
        ...
        flip: {
          left: function (t, e) {
            ...
            c < 0
              ? ((i = t.left + d + p + f + e.collisionWidth - r - a) < 0 ||
                ...
                (t.left += d + p + f)
              : u > 0 &&
                ((n = t.left - e.collisionPosition.marginLeft + d + p + f - h) >
                  0 ||
                  s(n) < u) &&
                (t.left += d + p + f);
          },
          top: function (t, e) {
            var i,
              ...
              f = -2 * e.offset[1];
            c < 0
              ? ((n = t.top + d + p + f + e.collisionHeight - r - a) < 0 ||
                  n < s(c)) &&
                (t.top += d + p + f)
              : u > 0 &&
    ...
    (function (t, e) {
      ...
      function d(e) {
        ...
        return (
          ...
          r.length
            ? ("0,0,0,0" === r.join() && t.extend(r, i.transparent), s)
            : i[e]
        );
      }
      function p(t, e, i) {
      ...
      (l.style.cssText = "background-color:rgba(1,1,1,.5)"),
        ...
        (o.fn = t.extend(o.prototype, {
          parse: function (e, s, n, r) {
            ...
            var h = this,
              ...
              p = (this._rgba = []);
            return (
              void 0 !== s && ((e = [e, s, n, r]), (l = "array")),
              "string" === l
                ? this.parse(d(e) || i._default)
                : "array" === l
                ? (c(a.rgba.props, function (t, i) {
                    p[i.idx] = u(e[i.idx], i);
                  }),
                  this)
                : "object" === l
                    ...
                    e instanceof o
                      ...
                      : function (i, s) {
                          ...
                          c(s.props, function (t, i) {
                            ...
                            h[n] &&
                              t.inArray(null, h[n].slice(0, 3)) < 0 &&
                              ((h[n][3] = 1),
                              s.from && (h._rgba = s.from(h[n])));
                        }
                  ),
                  this)
                : void 0
        ...
        (t.cssHooks.borderColor = {
          expand: function (t) {
            var e = {};
            return (
              c(["Top", "Right", "Bottom", "Left"], function (i, s) {
                e["border" + s + "Color"] = t;
              }),
              e
            );
          ...
          t.extend(t.effects, {
            ...
            restore: function (t, e) {
              for (var i, s = 0, n = e.length; s < n; s++)
                null !== e[s] &&
                  ((i = t.data("ui-effects-" + e[s])), t.css(e[s], i));
            },
  ...
  t.effects,
    ...
    t.effects.define("bounce", function (e, i) {
      ...
      for (
        ...
        ((s = {})[m] = (_ ? "-=" : "+=") + u),
          ...
          (u = h ? 2 * u : u / 2);
      h &&
        (((s = { opacity: 0 })[m] = (_ ? "-=" : "+=") + u), a.animate(s, f, g)),
        a.queue(i),
    ...
    t.effects.define("fold", "hide", function (e, i) {
      ...
      h && (r = (parseInt(h[1], 10) / 100) * g[a ? 0 : 1]),
        ...
        (f.clip[l[1]] = 0),
        o &&
          (s.cssClip(f.clip), u && u.css(t.effects.clipToBox(f)), (f.clip = d)),
        s
          .queue(function (i) {
            u &&
              u
        ...
        (n = i || {}),
          ...
          h &&
            ...
            null !== r &&
              void 0 !== n.dateFormat &&
              void 0 === n.maxDate &&
              (h.settings.maxDate = this._formatDate(h, r)),
            "disabled" in n &&
              (n.disabled
          ...
          !1 !==
            ...
            i.inline ||
              ...
              t.effects && t.effects.effect[r]
                ? i.dpDiv.show(r, t.datepicker._get(i, "showOptions"), h)
                : i.dpDiv[r || "show"](r ? h : null),
  ...
  t.widget("ui.resizable", t.ui.mouse, {
    ...
    _mouseCapture: function (e) {
      ...
      for (i in this.handles)
        ((s = t(this.handles[i])[0]) === e.target || t.contains(s, e.target)) &&
          (n = !0);
  ...
  var _ = (t.ui.intersect = (function () {
    ...
    return function (e, i, s, n) {
      ...
      switch (s) {
        ...
        case "touch":
          return (
            ((a >= c && a <= d) || (h >= c && h <= d) || (a < c && h > d)) &&
            ((o >= l && o <= u) || (r >= l && r <= u) || (o < l && r > u))
          );
        default:
          return !1;
      }
        ...
        t.each(
          ...
          function () {
            this.options &&
              (!this.options.disabled &&
                this.visible &&
                _(e, this, this.options.tolerance, i) &&
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                "touch" === n.tolerance
                  ...
                  : "fit" === n.tolerance &&
                    (l =
                      c.left > o && c.right < r && c.top > a && c.bottom < h),
                l
                  ? (i.selected &&
